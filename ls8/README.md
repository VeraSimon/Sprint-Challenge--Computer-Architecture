...
* Write a short 3-10-word description of what each file does.
    * LS8-spec.md: The CPU specification
    * README.md: This readme
    * cpu.h: Headers for our "CPU", defining our basic CPU structure and its instruction set
    * cpu.c: CPU implementation functions
    * ls8.c: Our main loop
    * examples/: Collection of example programs to run as features are implemented
